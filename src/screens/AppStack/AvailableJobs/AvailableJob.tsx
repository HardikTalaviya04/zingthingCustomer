...
const AvailableJob = () => {
    ...
    return (
      <View style={styles.mainBody}>
        ...
        <View style={{flexDirection:'row',paddingHorizontal:40,justifyContent:'space-between',marginTop:10,width:Dimensions.get("window").width}}>
            <TouchableOpacity style={{borderBottomColor:"orange",borderBottomWidth:SectionSelect=='local'?6:0}}
            onPress={()=>SetSectionSelect("local")}
            >
                <Text style={{color:'black',fontWeight:"600"}}>Local Jobs</Text>
            </TouchableOpacity>
            <TouchableOpacity
             style={{borderBottomColor:"orange",borderBottomWidth:SectionSelect=='all'?6:0}}
